...
目标方法(某后端系统真实代码,判断整体响应状态):

```java
public HeadCodeEnum getHeadCodeEnumByRespCode(List<PullPrice网关Resp> respList) {
    Map<Boolean,List<PullPrice网关Resp>> m = respList.stream()
